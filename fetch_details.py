...
def gen_page_ordered(title, source_url, region, pubdate, ordered_items, en_text=''):
    ...
    css = (
        ...
        'background:#fff;color:#334155;padding:22px 18px 48px;line-height:1.6}'
        'main{max-width:760px;margin:0 auto}'
        'h1{font-size:32px;line-height:1.35;color:#0f172a;margin:18px 0 10px;font-weight:800}'
        ...
        'h2,h3{color:#0f172a}'
        'p{font-size:18px;line-height:1.9;color:#334155;margin:16px 0}'
        ...
        '@media(max-width:600px){body{padding:18px 14px 36px}h1{font-size:27px}p{font-size:17px}}'
        '</style>'
    )
    return (
        '<!DOCTYPE html>\n<html lang="zh-CN">\n<head>\n<meta charset="UTF-8">\n'
